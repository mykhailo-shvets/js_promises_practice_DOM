...
const successHandler = (successMessage)=>{
    body.insertAdjacentHTML("beforeend", `<div class="success" data-qa="notification">${successMessage}</div>`);
};
const errorHandler = (errorMessage)=>{
    body.insertAdjacentHTML("beforeend", `<div class="error" data-qa="notification">${errorMessage}</div>`);
};
firtPromise.then(successHandler).catch(errorHandler);
